            ...
            <div className="flex flex-wrap items-center md:justify-between justify-center">
              <div className="w-full md:w-6/12 px-4 mx-auto text-center">
                <div className="text-sm text-blueGray-500 font-semibold py-1">
                  Copyright by &copy; <a href="http://mohitsinghport.netlify.app/" className="text-blue hover:text-gray-800" target="_blank">Mohit Singh</a>. <a className="text-blueGray-500 hover:text-blueGray-800" target="_blank">All Rights Reserved.</a>
                </div>
              </div>
            </div>
          </div>
